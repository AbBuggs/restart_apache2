...
then
    ...
    # exit 1
    echo -e "\e[35mERROR:\e[0m \e[1m\e[36m${CONFIG}\e[0m \e[32mis NOT a valid virtual-host\e[0m \nPlease choose from the following ${VALID_VHOSTS}"
    exit 1
